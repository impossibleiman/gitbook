...
I also edited the console mode from tty to /dev/console.
...
`apt update && apt install openjdk-21-jre-headless -y` Using Java 21 we can utilise it's newly added garbage collector called ZGC instead of 1GC to help use more cores.
...
This is the convential way of copying files over, however for convenience I will use FileZilla which I have used in the past with extneral minecraft server providers.
